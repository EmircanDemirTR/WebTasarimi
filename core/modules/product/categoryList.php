<div class="col-lg-12">
  <div class="card">
	...
	<div class="card-header d-flex align-items-center">
	  <h3 class="h4">Kategori Listesi&nbsp;&nbsp;&nbsp;</h3>
	</div>
	<div class="card-body">
	<?PHP print $adminEngine->processMessage(); ?>
  
	 <?PHP print $adminEngine->categoryList("3"); ?>
	</div>
  </div>
</div>
...
if($adminEngine->issetDelete() && $adminEngine->getDeleteID() != ""){
	...
	if($adminEngine->deleteDB("md_page","page_id",$adminEngine->getDeleteID())){
		...
		$adminEngine->deleteDB("md_product_relationships","category_id",$adminEngine->getDeleteID());
		
		$path = array("page/images/", "page/images/thumb/");
		
		imgDelete($path, $adminEngine->getDeleteID() . ".jpg");
		
		redirect("main.php?module=product/categoryList&success");
	
	} else {
	
		redirect("main.php?module=product/categoryList&failed");	
