...
function parentSelectBoxMenu1($parent, $value = "", $editID, $editParent, $editGroup)
{
	...
	$query = "SELECT * FROM md_page WHERE (page_group = '". $newGroup ."') AND (page_parent = '". $parent ."') AND (page_id != '". $newID ."') ORDER BY page_order ASC";
...
function parentSelectBoxMenu2($parent, $value = "", $groupID){
	...
	$query = "SELECT * FROM md_page WHERE (page_group = '". $groupID ."') AND (page_parent = '". $parent ."') ORDER BY page_order DESC";
