...
<li class="nav-item"><a class="nav-link active" id="home-info" data-toggle="tab" href="#info" aria-controls="1" aria-expanded="true">İçerik Yazıları</a></li>
<li class="nav-item"><a class="nav-link" id="home-features" data-toggle="tab" href="#features" aria-controls="1" aria-expanded="true">Özellikler</a></li>
<li class="nav-item"><a class="nav-link" id="home-seo" data-toggle="tab" href="#seo" aria-controls="1" aria-expanded="true">SEO</a></li>

</ul>

<form class="form-horizontal" action="main.php?module=page/pageedit&id=<?PHP print $getData->siteConfig["getID"]; ?>"  method="post">
  ...
  <div class="tab-content" id="myTabContent">
    ...
    <div class="clearfix" style="height: 40px;"></div>
	 ...
	 <div class="form-group row">
        ...
        <div class="col-sm-4">
          <input name="p1" type="text" id="p1" class="form-control" placeholder="İçerik Başlığı" value="<?PHP print unhtmlDBString2($editData["page_title1"]);?>">
        </div>
      </div>
	 ...
	 <div class="form-group row">
        <label class="col-sm-2 form-control-label">Sayfa URL</label>
        <div class="col-sm-4">
	 ...
	 <div class="form-group row">
        <label class="col-sm-2 form-control-label">İçerik Özet</label>
        <div class="col-sm-6">
	...
	<div class="form-group row">
		<label class="col-sm-2 form-control-label">İçerik Detay</label>
		<div class="col-sm-9">
	...
	?>
	 ...
	 <div class="form-group row">
        <label class="col-sm-2 form-control-label">Sayfa Tasarımı</label>
        <div class="col-sm-3">
	 ...
	 <div class="form-group row">
        <label class="col-sm-2 form-control-label">Link Grubu</label>
        <div class="col-sm-3">
	 ...
	 <div class="form-group row">
        <label class="col-sm-2 form-control-label">Galeri</label>
        <div class="col-sm-3">
	 ...
	 <div class="form-group row">
        <label class="col-sm-2 form-control-label">Durumu</label>
        <div class="col-sm-3">
    ...
    <div class="clearfix" style="height: 40px;"></div>
	 ...
	 <div class="form-group row">
        <label class="col-sm-2 form-control-label">Anahtar Kelimeler</label>
        <div class="col-sm-3">
...
if($_POST){
	...
	$data = array( 	"page_title1" => $_POST["p1"],
					...
					"page_content2" => $_POST["p27"],

					"page_content3" => $_POST["p35"],
