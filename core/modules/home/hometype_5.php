...
<div class="clearfix"></div>
    ...
    <div class="form-group">
        <label class="form-control-label">Demo Url</label>
        <input name="pn3" type="text" id="pn3" placeholder="Demo Url" class="form-control" value="<?PHP print unhtmlDBString2($editData["page_url2"]);?>">
    </div>
