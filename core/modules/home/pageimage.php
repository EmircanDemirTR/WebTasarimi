  ...
  <div class="tab-content" id="myTabContent">
    ...
    <form action="main.php?module=page/pageimage&id=<?PHP print $getData->siteConfig["getID"]; ?>" method="post" enctype="multipart/form-data" class="avatar">
        ...
        <div class="col-sm-6">
        	...
        	<?php if($editData["page_group"]=="6"){ ?>
            <div class="slim" data-fetcher="fetch.php"  data-size="500,194">
                <input type="file"  required/>
            </div>
            <?php }elseif($editData["page_group"]=="7"){ ?>
            <div class="slim" data-fetcher="fetch.php"  data-size="760,505">
                <input type="file"  required/>
            </div>
            <?php }else{ ?>
            <div class="slim" data-fetcher="fetch.php"  data-size="700,525">
                <input type="file"  required/>
            </div>
            <?php } ?>
