							...
							<div class="col-lg-12 col-xl-12">
								<div class="row">
									<div class="col-md-6 col-xl-4">
										<div class="blog-item">
											<div class="blog-item__img"><img class="img--bg" src="img/bloglar.jpg" alt="img"/></div><span class="blog-item__category">Blog</span>
											<h6 class="blog-item__title"> <a href="blog-detay.php">Blog Yazısı</a></h6>
											<div class="blog-item__text">Blog yazısının açıklamasının kısa detay kısmının bulunacağı alandır.</div>
											<div class="blog-item__details"><span>12/01/2021</span></div>
										</div>
									</div>
									<div class="col-md-6 col-xl-4">
										<div class="blog-item">
