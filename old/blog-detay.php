							...
							<div class="col-12">
								<div class="align-container">
									<div class="align-container__item"><span class="hero-block__overlay">Solo</span>
										<h1 class="hero-block__title">Blog Detay</h1>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-12 col-xl-12">
								<div class="row">
									<div class="col-12"><img class="blog-post__img" src="img/blog-detay.jpg" alt="img"/>
										<h4 class="blog-post__title">Blog Başlık</h4>
								...
								<div class="row top-20">
									<div class="col-6">
										<div class="blog-post__date">02/2/2021</div>
									</div>
								</div>								
							</div>
						</div>
