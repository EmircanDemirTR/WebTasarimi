							...
							<div class="col-12">
								<div class="align-container">
									<div class="align-container__item"><span class="hero-block__overlay">Solo</span>
										<h1 class="hero-block__title">Referanslar</h1>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row bottom-50">
							<div class="col-12">
								<div class="heading heading--center heading--white">
									<h3 class="heading__title">Referanslar</h3>
								</div>
							</div>
						</div>
						<div class="row offset-50">
							<div class="col-md-6 col-lg-4 col-xl-3">
								<div class="certificate">
									<div class="certificate__img"><img src="img/ref.jpg" alt="certificate"/></div>
									<h6 class="certificate__title"><a href="#">Koç Holding</a></h6>
									<p>Açıklama Alanı</p>
								</div>
							</div>
							<div class="col-md-6 col-lg-4 col-xl-3">
